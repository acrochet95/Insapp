...
public class Event implements Parcelable, Comparable<Event> {
    ...
    private String photoURL, bgColor, fgColor;
    ...
    public Event(String id, String name, String association, String description, ArrayList<String> participants, String status, Date dateStart, Date dateEnd, String photoURL, String bgColor, String fgColor) {
        this.id = id;
        this.name = name;
    ...
    public Event(JSONObject json) throws JSONException {
        ...
        this.photoURL = json.getString("image");
